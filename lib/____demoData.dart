...
class Demo{
  ...
  static final demoEvents = [
    EventModel(time: DateTime(2021,4,18), event: 'Weedding'),
    EventModel(time: DateTime(2021,4,19), event: 'Weedding'),
    EventModel(time: DateTime(2021,4,19), event: 'Weedding'),
    EventModel(time: DateTime(2021,4,21), event: 'Weedding'),
